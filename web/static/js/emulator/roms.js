//
// @fileoverview C64 ROM Data - BASIC, KERNAL, and Character ROM images
// @module emulator/roms
//
// This module contains the ROM data required for C64 emulation:
// - rom_chars: Character ROM (4KB) - character set bitmap data
// - rom_basic: BASIC ROM (8KB) - Commodore BASIC interpreter
// - rom_kernal: KERNAL ROM (8KB) - operating system routines
//
// These ROMs are exported as ES6 module constants for use by machine.js.
// The data is stored as Uint8Array for efficient memory access.
//
// Memory locations:
// - Character ROM: $D000-$DFFF (visible when CHAREN=0 and HIRAM or LORAM=1)
// - BASIC ROM: $A000-$BFFF (visible when LORAM=1 and HIRAM=1)
// - KERNAL ROM: $E000-$FFFF (visible when HIRAM=1)
//
// For C64 machine emulation, see machine.js.
//
// @see https://www.turbo8bit.com/
//
export const rom_chars = new Uint8Array([
...
export const rom_kernal = new Uint8Array([
...
export const rom_basic = new Uint8Array([
